...
public class ImpressaoContaWriterConfig {
	...
	@Bean
	public JdbcBatchItemWriter<Conta> jdbcContaWriter( // JdbcBatchItemWriter executa a escrita em lote, ou seja com apenas uma transação, não uma transação para cada escrita
